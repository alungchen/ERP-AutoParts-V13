...
import { Layers, Search, BarChart3, Settings, ShieldAlert, Users, FileText, Globe, Keyboard, ChevronLeft, ChevronRight, ScanLine, Wallet, History } from 'lucide-react';
...
const Sidebar = () => {
    ...
    const staticNavItems = [
        ...
        { name: t('sidebar.salesHistory'), path: '/sales-history', icon: History },
