...
(async () => {
  ...
  await page.evaluate(() => {
    ...
    document.querySelector('#ele_QueryMaster').value = '2026-05-15'; // There were records on 2026-05-15 as per html
  ...
  console.log("docNo after search:", docNo);
  
  await page.screenshot({path: 'scripts/test_search.png'});
