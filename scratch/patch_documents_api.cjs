...
const targetFile = path.join(__dirname, '../functions/api/documents.js');

const codeContent = `const STOCK_IMPACT = {
    purchase: 1,       // 進貨：+qty
    sales: -1,         // 銷貨：-qty
...
console.log('Successfully rewrote documents.js with explicit location logic!');
